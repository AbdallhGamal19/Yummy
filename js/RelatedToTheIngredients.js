...
let nameOfIngredients =localStorage.getItem('nameOfIngredients');
console.log(nameOfIngredients);
async function getDataOfMeals(nameOfIngredients) {
    let response = await fetch (`https://www.themealdb.com/api/json/v1/1/filter.php?i=${nameOfIngredients}`);
...
getDataOfMeals(nameOfIngredients);