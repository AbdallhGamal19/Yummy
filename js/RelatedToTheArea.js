...
let nameOfArea =localStorage.getItem('nameOfArea');
async function getDataOfMeals(nameOfArea) {
    let response = await fetch (`https://www.themealdb.com/api/json/v1/1/filter.php?a=${nameOfArea}`);
